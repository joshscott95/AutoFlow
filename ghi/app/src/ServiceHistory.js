    ...
    return (
      <div className="container-fluid">
        ...
        <div className ="input-group mb-3">
            <input onChange={handleTypeVinChange} value={typeVin} type="text" className="form-control" placeholder="Search by VIN..." aria-label="Search by VIN..." aria-describedby="button-addon2"/>
            <button className="btn btn-outline-secondary" onClick={event => setSearchVin(event.target.value)} value={typeVin} type="button" id="button-addon2">Search</button>
        </div>
