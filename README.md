...
graph TD;
    subgraph Project-Beta CarCar
        ...
        C --> E2[Service Poller] --> B
        D --> E3[Sales Poller] --> B
        B -.->|CRUD Operations|F[Database]
        C -.->|CRUD Operations|F[Database]
        D -.->|CRUD Operations|F[Database]
end
```
